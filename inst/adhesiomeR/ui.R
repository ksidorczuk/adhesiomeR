...
shinyUI(navbarPage("AdhesiomeR",
                   ...
                   tabPanel("Report",
                            checkboxInput("report_summary",
                                          "Plot with summary of systems presence",
                                          value = TRUE),
                            checkboxInput("report_genes",
                                          "Plot with presence of all genes",
                                          value = TRUE),
                            checkboxInput("report_systems",
                                          "Plots with each system seperately",
                                          value = TRUE),
