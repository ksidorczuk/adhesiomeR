...
shinyUI(navbarPage(title = "adhesiomeR",
                   ...
                   tabPanel("Input & settings",
                            sidebarPanel(width = 6,
                                         ...
                                         h5(tags$b("Select number of threads used when running analysis:")),
                                         ...
                                         HTML("<hr>"),
                                         h5(tags$b("Step 2.")),
                                         # radioButtons("mode", "Selected analysis mode:", 
                                         #              choices = c("Strict", "Relaxed"), 
                                         #              selected = "Strict"),
                                         # HTML("<hr>"),
                                         pickerInput("systems",
                                         ...
                                         # HTML("<hr>"),
                                         # h5(tags$b("Select threshold for gene presence: ")),
                                         # fluidRow(column(4,
